  ...
  return (
    ...
    >
      {forecast?.forecastday?.map((day, index) => (
        <div
          key={day.date_epoch}
          className={`hover:bg-slate-100 dark:hover:bg-slate-600 border-[0px] rounded-2xl bg-gray-900 bg-opacity-20   dark:border-slate-900 h-44 w-full grid grid-cols-4 grid-rows-2 justify-center items-center p-6 cursor-pointer ${
            active === index
