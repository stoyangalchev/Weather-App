...
export default function CurrentHourCard({ element }) {
  ...
  return (
    <div className='w-28 h-48 mt-5 mr-1 inline-block border-[0px] rounded-2xl bg-gray-900 bg-opacity-20   border-slate-900 text-center'>
      <div className='grid place-content-center place-items-center h-full '>
        ...
        <p className='text-white font-bold text-sm whitespace-pre-line h-16'>
